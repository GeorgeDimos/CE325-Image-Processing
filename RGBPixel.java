...
public class RGBPixel {
    ...
    /*Θέτει τις τιμές των τριών χρωμάτων με βάση τον ακέραιο value. 
    Η ακέραια μεταβλητή value περιέχει τα 3 RGB χρώματα.*/
    public void setRGB(int value){
	color = value;
    }

    /*Θέτει τις τιμές των τριών χρωμάτων με βάση τις τιμές των μεταβλητών red, green, blue .*/
    ...
    /*Επιστρέφει ένα αλφαριθμητικό στην μορφή “ (R,G,B) ”, όπου 
    R η τιμή του κόκκινου, 
    G η τιμή του πράσινού και
    B η τιμή του μπλε χρώματος .*/
    @Override
    public String toString(){
	return String.valueOf(this.getRed()) + " " + String.valueOf(this.getGreen()) + " " + String.valueOf(this.getBlue()+ " ");
    }
