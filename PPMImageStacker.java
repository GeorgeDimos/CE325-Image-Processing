...
public class PPMImageStacker {
    ...
    /*Λαμβάνει ως είσοδο ένα αρχείο το οποίο πρέπει να είναι 
    κατάλογος. Εάν το αρχείο δεν υπάρχει εμφανίζει το μήνυμα 
    “ [ERROR] Directory <dirname> does not exist! ”, ενώ εάν το 
    αρχείο υπάρχει αλλά δεν είναι κατάλογος εμφανίζει το μήνυμα 
	...
	for(int i=0;i<result.getHeight();i++){
		...
		iter = lst.iterator();
		result.setPixel(i, j, new RGBPixel((short)(red/size), (short)(green/size), (short)(blue/size)));
