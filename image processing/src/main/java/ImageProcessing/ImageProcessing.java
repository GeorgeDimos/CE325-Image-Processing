...
public class ImageProcessing {
	...
	public ImageProcessing() {
		...
		scrollPane = new JScrollPane(imgLabel, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
			...
			public void actionPerformed(ActionEvent ae) {
				...
				if (returnValue == JFileChooser.APPROVE_OPTION) {
					...
					try {
						...
						JOptionPane.showMessageDialog(frame, ex.getMessage(), "ERROR: File format",
			...
			public void actionPerformed(ActionEvent ae) {
				...
				if (returnValue == JFileChooser.APPROVE_OPTION) {
					...
					try {
						...
						JOptionPane.showMessageDialog(frame, ex.getMessage(), "ERROR: IO Error",
								JOptionPane.ERROR_MESSAGE);
					}
			...
			public void actionPerformed(ActionEvent ae) {
				...
				if (returnValue == JFileChooser.APPROVE_OPTION) {
					...
					if (selectedFile.exists()) {
						int answer = JOptionPane.showConfirmDialog(frame, "File exists! Overwrite ?", "Warning",
			...
			public void actionPerformed(ActionEvent ae) {
				...
				if (returnValue == JFileChooser.APPROVE_OPTION) {
					try {
						 ...
						 * catch(UnsupportedFileFormatException ex) { JOptionPane.showMessageDialog(
